...
public class StreamTest {
    ...
    public static void Test1(int count, int forCount) {
        ...
        System.out.println(
            "CountNanos for:" + forTimeCount + " forLam:" + forEachTimeCount + " stream:" + streamTimeCount
                + " parrelStream:"
                + parallelTimeCount);
        System.out.println(
            "CountMills for:" + forTimeCount * 1.0f / 1000000 + " forLam:" + forEachTimeCount * 1.0f / 1000000
                + " stream:" + streamTimeCount * 1.0f / 1000000 + " parrelStream:"
                + parallelTimeCount * 1.0f / 1000000 + "\n");
    }
    ...
    public static void Test2(int count, int forCount) {
        ...
        System.out.println(
            "CountNonos forEach:" + forTimeCount + " forLam:" + forEachTimeCount + " stream:" + streamTimeCount
                + " parrelStream:"
                + parallelTimeCount);
        System.out.println(
            "CountMills forEach:" + forTimeCount * 1.0f / 1000000 + " forLam:" + forEachTimeCount * 1.0f / 1000000
                + " stream:" + streamTimeCount * 1.0f / 1000000 + " parrelStream:"
                + parallelTimeCount * 1.0f / 1000000 + "\n");
    ...
    public static void TestSum(int count, int forCount) {
        ...
        for (int i = 0; i < forCount; i++) {
            ...
            //System.out.println("forSum:"+forSum+" forEachSum:"+forEachSum.getValue()+" streamSum:"+streamSum+"
            // parallelSum:"+parallelStreamSum);
            //System.out.println("length:" + bankAccountDTOfor.size() + " " + bankAccountDTOStream.size()+ " " +
            // bankAccountDTOparallelStream.size()+"\n");
        }
        System.out.println(
            "CountNanos for:" + forTimeCount + " forEach:" + forEachTimeCount + " forLam:" + forEachLamTimeCount
                + " stream:" + streamTimeCount + " parrelStream:"
                + parallelTimeCount);
        System.out.println(
            "CountMills for:" + forTimeCount * 1.0f / 1000000 + " forEach:" + forEachTimeCount * 1.0f / 1000000
                + " forLam:"
                + forEachLamTimeCount * 1.0f / 1000000 + " stream:" + streamTimeCount * 1.0f / 1000000
                + " parrelStream:"
                + parallelTimeCount * 1.0f / 1000000 + "\n");
